...
import { Code, Folder, Terminal, Save, Play, FilePlus, Keyboard } from 'lucide-react';

const Navigation = ({ activeTab, onTabClick, activeFile, onSave, onExecute, onNewFile, isExecuting }) => (
